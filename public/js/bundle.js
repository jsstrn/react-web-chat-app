      ...
      React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(
            'fieldset',
            null,
            React.createElement('input', { type: 'text', className: 'form-control ', placeholder: 'say what?', required: true, autofocus: true }),
            React.createElement(
              'button',
...
const HeadingSection = React.createClass({
  ...
  render: function () {
    return React.createElement(
      ...
      React.createElement(
        'span',
        { id: 'status', className: 'label label-default' },
        this.state.message
      )
    );
  }
...
const Layout = React.createClass({
  ...
  render: function () {
    return React.createElement(
      'div',
      null,
      React.createElement(HeadingSection, { message: this.state.message }),
...
socket.on('connect', function () {
  ...
  status = true;
  ReactDOM.render(React.createElement(Layout, { status: status }), document.querySelector('.container'));
});
